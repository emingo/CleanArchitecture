...
public class TodoItems : IEndpointGroup
{
    ...
    public static async Task<Created<int>> CreateTodoItem(ICommandMediator mediator, CreateTodoItemCommand command)
    {
    ...
    public static async Task<Results<NoContent, BadRequest>> UpdateTodoItem(ICommandMediator mediator, int id, UpdateTodoItemCommand command)
    {
        if (id != command.Id)
    ...
    public static async Task<Results<NoContent, BadRequest>> UpdateTodoItemDetail(ICommandMediator mediator, int id, UpdateTodoItemDetailCommand command)
    {
    ...
    public static async Task<NoContent> DeleteTodoItem(ICommandMediator mediator, int id)
    {
